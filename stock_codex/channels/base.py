...
them free of any platform/SDK import lets adapters (telegram/feishu/wecom/
weixin) and the gateway depend on a single small surface without cycles.
"""
...
class Capabilities:
    ...
    # by the listener process (e.g. WeCom AI Bot WS, WeChat iLink), so other
    # processes enqueue to channel_outbox instead of sending directly. Stateless
    # REST adapters (telegram/feishu) leave this False.
