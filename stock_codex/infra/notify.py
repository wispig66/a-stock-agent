...
推送统一经 ChannelGateway 发到当前启用的通道（feishu / weixin），
连接绑定型通道（weixin）会落到 outbox 由监听进程发送。
...
CHAT_ID = os.environ.get("FEISHU_HOME_CHANNEL") or os.environ.get("WEIXIN_HOME_CHANNEL") or ""
